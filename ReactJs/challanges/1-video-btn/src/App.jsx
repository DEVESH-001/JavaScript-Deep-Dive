...
export default function App() {
  ...
  /* Challenge
    ...
    You're creating a button that will allow the user to play and pause a video game. Your task is to set it up and insert it in the div below (line 29) as follows: 
        ...
        1. When the user clicks the button, the gameRunning state's boolean value should be set to 
           the opposite value of what it currently is (from true to false or vice-versa).
            
        2. If gameRunning is true, the button should display the word "Pause". If gameRunning is 
...
*/
  ...
  return (
    <div>
      ...
      <button onClick={handleClick}>{gameRunning ? "Play" : "Pause"}</button>
    </div>
  );
}
